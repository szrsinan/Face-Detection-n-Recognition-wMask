...
def stream(pb_path, node_dict,ref_dir,camera_source=0,resolution="480",to_write=False,save_dir=None):
    ...
    while(cap.isOpened()):
        ...
        if ret is True:
            ...
            if len(bboxes) > 0:
                for num, bbox in enumerate(bboxes):
                    ...
                    if len_ref_path > 0:
                        ...
                        print("The minimum distance: ", distance[arg])
            ...
            #image display
            cv2.imshow("HEALTHY FACES CONTROL CAM", img)
...
if __name__ == "__main__":
    camera_source = 0 
    pb_path = r"C:\Users\profo\OneDrive\Belgeler\Healthy Faces\pb_model_select_num=15.pb" #trained dataset
    node_dict = {'input': 'input:0',
                 'keep_prob': 'keep_prob:0',
                 'phase_train': 'phase_train:0',
                 'embeddings': 'embeddings:0',
                 }
    ref_dir = r"C:\Users\profo\OneDrive\Belgeler\Healthy Faces" #face images there
